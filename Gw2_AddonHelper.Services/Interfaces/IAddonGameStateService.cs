...
namespace Gw2_AddonHelper.Services.Interfaces
{
    ...
    {
        Task<IEnumerable<AddonContainer>> GetAddonContainers(IEnumerable<Addon> addons, VersionContainer versions);
        ...
        Task<IEnumerable<AddonContainer>> GetUpdateableAddons(IEnumerable<AddonContainer> installedAddons, VersionContainer versions);
