...
{
    public class AddonListSourceToUpdateButtonTextConverter : IMultiValueConverter
    {
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
                ...
                values[1] is IEnumerable<AddonContainer>)
            {
                ...
                {
                    if(addonContainers.Any(x => x.QuickUpdateAvailable))
                    {
                        return Localization.Localization.ButtonUpdateText;
                    }
                    else
                    {
                        return Localization.Localization.ButtonUpdatesNoUpdatesText;
                    }
                }
            }
